...
In this work, we propose a new lexicon based approach for text polarity detection using sentiment triggers which are adding contextual semantic during the analysis. Lexicon SentiWords.SR is based on the English version lexicon [SentiWords](https://arxiv.org/abs/1510.09079) containing roughly 155,000 English words associated with a sentiment score in the range [-1, 1]. SentiWords.SR contains ~15,000 words (e.g. lemma & PoS pairs) which are derived upon extensive evaluation of the translated lexicon.
